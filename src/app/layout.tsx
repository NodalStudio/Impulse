...
export const metadata: Metadata = {
  ...
  description: "Rejoignez la communauté Impulse : des événements mensuels à Barcelone pour les femmes entrepreneures qui veulent apprendre, s'entraider et agir ensemble. Networking, ateliers pratiques et entraide bienveillante.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Rejoignez la communauté Impulse : des événements mensuels à Barcelone pour les femmes entrepreneures qui veulent apprendre, s'entraider et agir ensemble.",
    images: [
      {
