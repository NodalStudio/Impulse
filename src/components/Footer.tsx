        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <nav aria-label="Navigation footer" className="flex flex-col gap-2">
              ...
              <a href="#contact" className="font-source text-sm text-white/70 hover:text-gold transition-colors">
                Rejoindre Impulse
              </a>
            </nav>
          </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-4 mt-4">
                <a
                  ...
                  aria-label="Profil LinkedIn Impulse"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="text-white/70 hover:text-gold transition-colors"
                  aria-label="Compte Instagram Impulse"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
