...
export default function Contact() {
  ...
  return (
    <section id="contact" className="snap-section bg-gradient-to-br from-cream via-beige/30 to-rose/20">
      {/* Mobile layout - vertically centered */}
      <div className="lg:hidden flex-1 flex flex-col min-h-0">
        <div className="flex-1 container-impulse px-4 flex flex-col justify-center pb-1 min-h-0">
          {/* Header with contact info - centered */}
          <div className="animate-fade-in-up flex-shrink-0 mb-3 text-center">
            <p className="font-montserrat uppercase tracking-[0.2em] text-navy text-xs mb-2">
              Contact
            </p>
            <div className="w-16 h-[1px] bg-gradient-to-r from-transparent via-gold to-transparent mx-auto mb-3"></div>
            ...
            <div className="bg-beige/30 rounded-lg p-3 text-center">
