export default function Mission() {
  return (
    <section id="mission" className="snap-section section-alt">
      <div className="container-impulse h-full flex items-center justify-center py-4">
        <div className="max-w-4xl mx-auto text-center px-4">
          {/* Manifeste - exact PDF wording with dynamic sizing */}
          <div className="animate-fade-in-up">
            <blockquote className="font-cormorant text-[clamp(0.95rem,2.5vh,1.5rem)] text-navy leading-relaxed mb-[2vh] xl:mb-6">
            ...
            {/* Tagline */}
            <p className="font-cormorant text-[clamp(1.1rem,3vh,1.5rem)] font-semibold text-navy mb-[2vh] xl:mb-8 animate-fade-in-up delay-100">
              Du business empowerment au féminin !
            </p>

            {/* Founders signatures */}
            <div className="border-t border-gold/30 pt-[2vh] xl:pt-6 animate-fade-in-up delay-200">
              <p className="font-greatvibes text-[clamp(1.25rem,3.5vh,1.875rem)] text-navy mb-1">
                Anaïs, Marina &amp; Sophie
              </p>
