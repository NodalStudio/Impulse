      ...
      <div className="container-impulse h-full flex flex-col justify-center py-2 lg:py-4">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="animate-fade-in-up">
            <blockquote className="font-cormorant text-[2vh] lg:text-[clamp(0.95rem,2.5vh,1.5rem)] text-navy leading-snug lg:leading-relaxed mb-[1.5vh] lg:mb-6">
            ...
            {/* Tagline */}
            <p className="font-cormorant text-[2.2vh] lg:text-[clamp(1.1rem,3vh,1.5rem)] font-semibold text-navy mb-[1.5vh] lg:mb-8 animate-fade-in-up delay-100">
